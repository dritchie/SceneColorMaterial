...
\remark{D: ``Our model is composed of several terms. Each may have multiple factors (give an example of this happening). Here's the mathematical expression of our probability distribution. The rest of section will describe each term in detail, blah blah blah.''}
