...
%				\factorStats(\variable{c_\factor}(\pattern), \variable{f_\factor}(\pattern)) \\
...
%		\sum_{\factor \in \term}
%		(
%			\termStats_\term(\variable{c_\factor}(\pattern), \variable{f_\factor}(\pattern)) \\
%				- \expectation_\weights[\termStats_\term(\variable{C_\factor}, \variable{f_\factor}(\pattern))]
%		)
\end{multline*}
%%
...
%		(
%			\termStats_\term(\variable{c_\factor}(\pattern), \variable{f_\factor}(\pattern)) \\
%			- \termStats_\term(\variable{\hat{c}_\factor}(\pattern), \variable{f_\factor}(\pattern))
%		)
\end{multline*}
%%
