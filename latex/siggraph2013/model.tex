...
While the exact weights learned depend on the training dataset, there are several strong general trends. TODO: Discuss trends.~\remark{Color compat, perceptual difference strong. Name stuff is not strong. Etc.}
