...
\end{equation*}
where $\textsl{top}$ are the color variables of the largest five groups in the pattern, and $t$ is the temperature of the model as defined previously. \remark{Actually, temperature hasn't been defined yet. We should also introduce the $\factor$ symbol better, as at present it's only defined in reference to Figure 3 and is easy to miss.}
