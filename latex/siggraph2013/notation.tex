...
\newcommand{\prop}{\pi}
\newcommand{\unaryProps}{\Pi^{Unary}}
\newcommand{\binaryProps}{\Pi^{Binary}}
...
\newcommand{\size}{A}
\newcommand{\groupInstStats}{\phi^{Group}_\pi}
\newcommand{\segInstStats}{\phi^{Seg}_\pi}
\newcommand{\adjInstStats}{\phi^{Adj}_\pi}

\newcommand{\colorCompatTerm}{\Phi^{ColorCompat}}
