...
\begin{figure}[ht]
\begin{tabular}{cc}
{\raisebox{4em}{\includegraphics[width=.25\columnwidth]{figs/histograms/backgroundGroup}}}&\includegraphics[width=.60\columnwidth]{figs/histograms/backgroundGroupHistogram}\vspace{0.5em}\\
{\raisebox{4em}{\includegraphics[width=.25\columnwidth]{figs/histograms/foregroundGroup}}}&\includegraphics[width=.60\columnwidth]{figs/histograms/foregroundGroupHistogram}\vspace{0.5em}\\
\end{tabular}
