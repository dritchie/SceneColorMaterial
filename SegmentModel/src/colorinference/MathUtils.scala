...
//        prod
    ...
    //def cosineDistance(a:Tensor1, b:Tensor1):Double = 1.0 - ((a.cosineSimilarity(b) + 1)*0.5)
    def cosineDistance(a:Tensor1, b:Tensor1):Double = 0.5*(1.0 - a.cosineSimilarity(b))
